...
9. sudo docker build --no-cache -t seethroughlab/runpod-worker-comfy:v0.11 --platform linux/amd64 .
10. sudo docker-compose up
11. sudo docker login -u "seethroughlab" docker.io
12. sudo docker push seethroughlab/runpod-worker-comfy:v0.11
